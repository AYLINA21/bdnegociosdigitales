...
/****** Object:  Table [dbo].[Clientes]    Script Date: 26/02/2026 09:09:27 p. m. ******/
SET ANSI_NULLS ON
GO
...
-- antes de hacer una vista se hace la consulta 
...
and ImportesDescuento > 34000;

--las vistas no pueden aber where ni order by ni columnas con el mismo nombre 
...
select 
r.Nombre,
r.Ventas as [ventas representantes],
o.Ciudad,
o.Region,
